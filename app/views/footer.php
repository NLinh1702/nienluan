      ...
      <div class="bg_in">
         <div class="footer footer_bottom">
            ...
            <div class="footer-col">
               ...
               <div class="footer-col-content">
                  <ul class="social">
                     <li><a href="" class="fb"><img src="<?php echo BASE_URL?>/public/user/image/Fb.png">Facebook</a></li>
                     <li><a href="#2" class="fb"><img src="<?php echo BASE_URL?>/public/user/image/GG.png">Google</a></li>
                  </ul>
                  <div class="clear"></div>
               </div>
            </div>
...
<script defer type="text/javascript" src="<?php echo BASE_URL?>/public/user/js/sweet-alert.js"></script>
<script defer type="text/javascript" src="<?php echo BASE_URL?>/public/user/js/jquery.flexslider-min.js"></script>
<script defer src="<?php echo BASE_URL?>/public/user/js/owl.carousel.js" type="text/javascript"></script>
<script defer src="<?php echo BASE_URL?>/public/user/js/jquery.lazyload.min.js" type="text/javascript"></script>
<script defer type="text/javascript" src="<?php echo BASE_URL?>/public/user/js/script_ex.js"></script>
<script defer type="text/javascript" src="<?php echo BASE_URL?>/public/user/js/script_menu.js"></script>
<script defer type="text/javascript" src="<?php echo BASE_URL?>/public/user/js/bootstrap.js"></script>
