                ...
                <div class="container_table">
                    ...
                    <tbody>
                        <form action='./gio-hang/' method="post">
                            <tr class="tr">
                                <td data-th="Hình ảnh">
                                <div class="col_table_image col_table_hidden-xs"><img src="<?php echo BASE_URL?>/public/user/image/iphone1.jpg" alt="Máy in laser Canon LBP251DW" class="img-responsive"/></div>
                                </td>
                                <td data-th="Sản phẩm">
                                ...
                                <div class="clear margintop5">
                                    <div class="floatleft"><input type="number" class="inputsoluong" name="qty[576]" min="1" value="1"></div>
                    ...
                    <div class="ch-contacts-details">
                        <ul class="contact-list">
                            <li class="addr">
                                ...
                                <p><em><strong>Niên luận CT446</strong></em><br />
                        ...
                        <div class="hiring-box">
                            ...
                            <p>Mọi thắc mắc bạn hãy gửi về mail của chúng tôi <strong>nhutlinh@gmail.com</strong> chúng tôi sẽ giải đáp cho bạn.</p>
