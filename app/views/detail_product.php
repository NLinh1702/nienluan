               ...
               <div class="content-right-items margin0">
                  ...
                  <div class="slider-galery ">
                     <div id="sync1" class="owl-carousel owl-theme">
                        <div class="item">
                           <img src="<?php echo BASE_URL?>/public/user/image/iphone.png" width="100%">
                        </div>
                        <div class="item">
                           <img src="<?php echo BASE_URL?>/public/user/image/iphone1.jpg" width="100%">
                        </div>
                        <div class="item">
                           <img src="<?php echo BASE_URL?>/public/user/image/iphonex.png" width="100%">
                        </div>
                     </div>
