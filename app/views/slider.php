            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <img src="<?php echo BASE_URL?>/public/user/image/slider3.jpg" alt="Siêu khuyến mãi">
                    </div>

                    <div class="item">
                        <img src="<?php echo BASE_URL?>/public/user/image/slider2.jpg" alt="Siêu khuyến mãi">
                    </div>
                    ...
                    <div class="panel-body scrollable-panel">
                        <div class="row">
                            <div class="col-md-4 col-xs-4 col-sm-4">
                                <img src="<?php echo BASE_URL?>/public/user/image/iphone.png">
                            </div>
